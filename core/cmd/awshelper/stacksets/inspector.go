...
func GetInspectorAdminDelegationStackSetConfig(orgMetadata *awshelper.AWSOrgMetadata, stackSetName, templateFile, templateURL string, isStandaloneDeployment, isMainRegionDeployment bool, deploymentTargets, excludedAccounts, standaloneAcountsOUIds []string) *awshelper.StackSetProps {
...
func GetInspectorEnablerStackSetConfig(orgMetadata *awshelper.AWSOrgMetadata, stackSetName, templateFile, templateURL string, isStandaloneDeployment, isMainRegionDeployment bool, deploymentTargets, excludedAccounts, standaloneAcountsOUIds []string) *awshelper.StackSetProps {
