"""Module for handling AWS IAM Resources Remediation and Deletion"""
from utils.logger import LOGGER

class IAM:
    """IAM Class used to handle IAM Resources actions cross-account"""
    ...
    def role_details(self, role_name):
        """Get details of an IAM Role using role_name"""
        try:
    ...
    def delete_access_key(self, iam_user, access_key):
        """Delete specified IAM Access Key of given IAM User"""
        try:
    ...
    def detach_role_policy(self, role_name, policy_arn):
        """Detach specific managed policy from given IAM Role"""
        try:
    ...
    def delete_role_policy(self, role_name, policy_name):
        """Delete inline policy from given IAM Role"""
        try:
    ...
    def delete_iam_login_profile(self, iam_user):
        """Delete login profile of given IAM User"""
        try:
