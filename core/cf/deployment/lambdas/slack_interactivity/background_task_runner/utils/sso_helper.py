        ...
        while retry_attempts < MAX_RETRY_ATTEMPTS:
            try:
                ...
                with ThreadPoolExecutor() as executor:
                    future_to_page = {executor.submit(self.process_account_page, page, active_accounts_details): page for page in paginator.paginate()}
                ...
                break
    def process_account_page(self, page, active_accounts_details):
